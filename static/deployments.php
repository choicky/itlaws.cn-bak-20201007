...
*/
$options = array(
    'directory'     => '/var/www/itlaws.cn', // Enter your server's git repo location
    'work_dir'      => '/var/www/itlaws.cn/public',  // Enter your server's work directory. If you don't separate git and work directories, please leave it empty or false.
    'log'           => 'deploy.log', // relative or absolute path where you save log file. Set it to false without quotation mark if you don't need to save log file.
    ...
    'syncSubmodule' => true, // If your repo has submodule, set it true. (haven't tested it if this actually works)
...
if ($_GET['key'] === $secret_key)  {
    ...
    $deploy->post_deploy = function() use ($deploy) {
      // hit the wp-admin page to update any db changes
       exec('hugo -s /var/www/itlaws.cn/ -d /var/www/itlaws.cn/public');
